    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Session save/load', link: '/how-to/session-save-load' },
          { text: 'Diff view (Subscribers)', link: '/how-to/diff-view' },
          { text: 'Manual dispatch (Re-fire)', link: '/how-to/manual-dispatch' },
          { text: 'Leak detection', link: '/how-to/leak-detection' },
          { text: 'Invoke timing', link: '/how-to/invoke-timing' },
          { text: 'Assembly filters', link: '/how-to/assembly-filters' },
          { text: 'Compare sessions', link: '/how-to/compare-sessions' },
          { text: 'Exception breadcrumbs', link: '/how-to/exception-breadcrumbs' },
          { text: 'Subscriber growth alerts', link: '/how-to/subscriber-growth-alerts' },
        ],
      },
      {
        text: 'Reference',
